      ...
      if (this.state.smclips.length > 1) {
        ...
        smclips = (
          <div className="maxed">
            ...
            >
              {this.state.smclips.map(smclip => (
                <div className="clips row">
                  <a target="_blank" href={`https://sclip.cc/${smclip._id}`}>
                    <div className="clipsitem" key={smclip.user}>
                      ...
                      <ImageFB
                        src={`https://cdn.sclip.cc/file/smartclips/${smclip._id}.jpg`}
            ...
            >
              {this.state.clips.map(clip => (
                <div className="clips row">
                  <a
                    target="_blank"
                    href={`https://mixer.com/${this.state.mixer.token}?clip=${clip.shareableId}`}
                  >
